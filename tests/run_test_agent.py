...
def main():
    ...
    image_path = os.path.join(project_root, "data", "sample_images", "test_4.jpg")
    ...
    print("="*60)
    print(" VĂN BẢN OCR THÔ:")
    print("="*60)
    print(extracted_text[:1000] + "\n...\n") 

    print("[3] Kích hoạt Agentic AI để phân tích và tự sửa lỗi...\n")
